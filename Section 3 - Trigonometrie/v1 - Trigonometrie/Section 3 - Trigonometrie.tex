		...
		\subsection{Définition}
			...
			\subsubsection*{Domaine de définition et ensemble d'arrivée}
				...
				\end{center}
					...
					Pour les fonctions arcsinus et arccosinus :
					\begin{itemize}
						\item [•] Leur domaine de définition est $\mathbb{R}$.
						\item [•] Leur ensemble d'arrivée est l'intervalle $[-1~;~1]$.
					\end{itemize}
				...
				\begin{itemize}
					\item [•] La fonction $\arcsin$ est définie sur l'intervale $[-1~;~1]$ et à pour ensemble d'arrivée $[-\frac{\pi}{2}~;~\frac{\pi}{2}]$.
					\item [•] La fonction $\arccos$ est définie sur l'intervale $[-1~;~1]$ et à pour ensemble d'arrivée $[0~;~\pi]$.
					\item [•] La fonction $\arctan$ est définie sur $\mathbb{R}$ et à pour ensemble d'arrivée $\left]-\frac{\pi}{2}~;~\frac{\pi}{2}\right[$.
				\end{itemize}
			...
			\paragraph*{Propriétés}
				...
				\begin{itemize}
					\item [•] Les fonctions $\arcsin$ et $\arccos$ sont impaires, la fonction $\arctan$ est impaire sur $\mathbb{R}$.
					\item [•] Les fonctions $\arcsin$ et $\arccos$ sont croissantes, la fonction $\arctan$ est croissante sur $\mathbb{R}$.
					\item [•] Les fonctions $\arcsin$ et $\arccos$ sont dérivables sur $]-1~;~1[$, la fonction $\arctan$ est dérivable sur $\mathbb{R}$.
				\end{itemize}

		%\subsection{Représentation graphique}
		%	\begin{center}
		%		\makebox[\textwidth][c]{
		%			\includegraphics[height=23.25cm]{Graphs fonctions/arcsin_arccos_modifie.png
