		...
		\subsection{Étude de fonction}
			\subsubsection{Définition de ces fonctions}
				\paragraph*{Définition}
					La fonction sinus associe à tout réel $x$, le réel $\sin(x)$.
					
					est définie sur $\mathbb{R}$, et à chaque réel $x$, elle associe le réel $\sin(x)$.
					De même, la fonction cosinus est définie sur $\mathbb{R}$, et à chaque réel $x$, elle associe le réel $\cos(x)$.
					Enfin, la fonction tangente est définie sur $\mathbb{R}$, et à chaque réel $x$, elle associe le réel $\tan(x)$.
				\paragraph*{Formules}
					La fonction sinus est définie par la formule $\sin(x) = \frac{O}{H}$, la fonction cosinus est définie par la formule $\cos(x) = \frac{A}{H}$ et la fonction tangente est définie par la formule $\tan(x) = \frac{O}{A}$.
				\paragraph*{Domaine de définition}
					Le domaine de définition de ces fonctions est $\mathbb{R}$.

			\subsubsection{Propriétés de ces fonctions}
				
				\paragraph*{Propriétés simples}
					\subparagraph*{Périodicité}
						...
						Ou exprimé plus rigoureusement, pour tout réel $x$, on a $\sin(x) = \sin(x + 2\pi)$, $\cos(x) = \cos(x + 2\pi)$ et $\tan(x) = \tan(x + 2\pi)$.
					\subparagraph*{Parité}
