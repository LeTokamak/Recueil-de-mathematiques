...
Les polygones sont classées en fonction de leur nombre de côté\footnote{
	La nomenclature des polygones est présenté en Annexe, à la page \pageref{nomenclature_polygone_polyèdre}.
} :
...
%https://fr.wikipedia.org/wiki/Th%C3%A9or%C3%A8me_de_Pythagore#Selon_Euclide,_livre_I
