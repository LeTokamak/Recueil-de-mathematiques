...
\begin{center}
	\begin{tabular}{ccc|ccc}
		\includegraphics[width=2cm]{Image/Triangles/triangle_equilateral_complet.png} &
		\includegraphics[width=2cm]{Image/Triangles/triangle_isocele_complet.png}     &
		\includegraphics[width=2cm]{Image/Triangles/triangle_scalene_complet.png}     &
		\includegraphics[width=2cm]{Image/Triangles/triangle_rectangle_complet.png}   &
		\includegraphics[width=2.5cm]{Image/Triangles/triangle_optusangle_complet.png}  &
		\includegraphics[width=2cm]{Image/Triangles/triangle_actuangle_complet.png}   \\
...
\begin{itemize}
	\item[•] $a = \sqrt{c^2 - b^2}$ \phantom{\huge{H}}
	\item[•] $b = \sqrt{c^2 - a^2}$ \phantom{\huge{H}}
	\item[•] $c = \sqrt{a^2 + b^2}$ \phantom{\huge{H}}
\end{itemize}
