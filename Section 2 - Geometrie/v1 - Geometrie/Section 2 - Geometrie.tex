...
L'unité la plus commune pour mesurer des angles est le \emph{degré} (noté $^\circ$),
...
d'un angle plein, et chaque choix apporte certains avantages.

En \emph{degré}, l'intérêt du nombre 360 s'explique
par la multitude de diviseur dont il dispose. 

En \emph{radian}, $2\pi$ correspond au périmètre
d'un cercle de rayon unitaire, ce qui est (en résumé) très cohérent mathématiquement.

En \emph{grade}, un angle droit mesure 100, nombre étant facilement manipulable.
...
\begin{center}
	\makebox[\textwidth][c]{
		\begin{tabular}{ccc|ccc}
			...
			\includegraphics[width=2.5cm]{Image/Triangles/triangle_acutangle_complet.png}   \\

			\textit{Triangle}    & \textit{Triangle}       & \textit{Triangle} & \textit{Triangle}         & \textit{Triangle}           & \textit{Triangle}  \\
			\textit{équilatéral} & \textit{isocèle en $B$} & \textit{scalène}  & \textit{rectangle en $D$} & \textit{obtusangle en $G$}  & \textit{acutangle} \\
		\end{tabular}
	}
\end{center}
...
\begin{center}
	\makebox[\textwidth][c]{
		\begin{tabular}{ccc}
			\includegraphics[width=5cm]{Image/Pythagore/figure_hypo_cas_1.png} & \includegraphics[width=5cm]{Image/Pythagore/figure_hypo_cas_2.png} & \includegraphics[width=5cm]{Image/Pythagore/figure_hypo_cas_3.png} \\
...
\begin{center}
	\makebox[\textwidth][c]{\includegraphics[width=16cm]{Image/Venn_type_quadrilateres_v2_plus.png}}
\end{center}
...
De plus, c'est aussi un parallélogramme dont les diagonales sont perpendiculaires.
...
\makebox[14cm][r]{ \includegraphics[height=2cm]{Image/Licence/licence.png} }
